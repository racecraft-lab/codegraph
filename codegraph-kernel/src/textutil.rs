...
/// Strip balanced angle-bracket groups at any nesting depth, matching
/// `stripAngleBracketGroups` in `src/utils.ts`.
pub fn strip_angle_bracket_groups(input: &str) -> String {
...
mod tests {
    ...
    #[test]
    fn strips_nested_angle_bracket_groups() {
        assert_eq!(strip_angle_bracket_groups("Map<String, List<User>>"), "Map");
        assert_eq!(strip_angle_bracket_groups("Result<script<Value>>"), "Result");
        assert_eq!(strip_angle_bracket_groups("Ns.Type>"), "Ns.Type>");
    }
