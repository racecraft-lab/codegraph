---
name: "validate-linux"
description: "Validate codegraph on Linux via Docker on the macOS host. Use when the user asks to test, validate, or reproduce behavior on Linux — especially platform-sensitive work: file watching, inotify budget, sockets, path/symlink handling, process lifecycle, daemon reaping."
argument-hint: "Optional: a test file/pattern to run, or 'watcher' for inotify-focused checks"
---
