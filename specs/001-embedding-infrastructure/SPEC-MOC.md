...
spec_id: "SPEC-001"          # e.g., PRSG-002 — namespace-matches the containing directory
structureVersion: 1          # keep in sync with the lint scripts' hardcoded literal
---

# SPEC-001 — Map of Content
...
- [contracts/embedding-config.md](contracts/embedding-config.md)
...
- [.process/layer-plan.json](.process/layer-plan.json)
- [.process/pr-packets/packet-a/validation.json](.process/pr-packets/packet-a/validation.json)
- [.process/pr-packets/packet-b/validation.json](.process/pr-packets/packet-b/validation.json)
- [.process/pr/body-a.md](.process/pr/body-a.md)
- [.process/pr/body-b.md](.process/pr/body-b.md)
- [.process/pr/changed-files-a.txt](.process/pr/changed-files-a.txt)
- [.process/pr/changed-files-b.txt](.process/pr/changed-files-b.txt)
- [.process/pr/packet-a.json](.process/pr/packet-a.json)
- [.process/pr/packet-b.json](.process/pr/packet-b.json)
