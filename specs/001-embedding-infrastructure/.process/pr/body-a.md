...
- [x] *(Stories 2–3 functionality lands in the stacked PR; validated there on its head.)* Story 2 confirmed: editing or deleting code and running `sync` keeps
...
- [x] *(Stories 2–3 functionality lands in the stacked PR; validated there on its head.)* Story 3 confirmed: turning on embeddings after the fact backfills to
