...
spec_id: "SPEC-002"          # e.g., PRSG-002 — namespace-matches the containing directory
structureVersion: 1          # keep in sync with the lint scripts' hardcoded literal
---

# SPEC-002 — Map of Content
...
- [contracts/local-provider.md](contracts/local-provider.md)
- [contracts/model-fetch.md](contracts/model-fetch.md)
