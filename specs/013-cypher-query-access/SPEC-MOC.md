...
# Consumed by speckit-scaffold-spec via token substitution (the same token
# mechanism as workflow-template.md).
#
...
#     relative []() target from this value and resolves it.
...
spec_id: "SPEC-013"          # namespace-matches the containing directory
structureVersion: 1          # keep in sync with the lint scripts' hardcoded literal
---

# SPEC-013 — Map of Content
