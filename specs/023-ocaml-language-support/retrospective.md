...
| Reviewability | Split-ready work, projected 10-16 total files. | Final gate reports 1250 reviewable LOC, 16 production files, 90 total files; final backstop proceeds through a maintainer-authorized infra exception. | Significant |
...
Evidence: final reviewability reports `status=exception`, `reviewable_loc=1250`,
