...
# Generated from the shared spec-moc template for SPEC-004.
#
...
spec_id: "SPEC-004"          # e.g., PRSG-002 — namespace-matches the containing directory
structureVersion: 1          # keep in sync with the lint scripts' hardcoded literal
---

# SPEC-004 - Map of Content
...
- [.process/pr-packets/single.json](.process/pr-packets/single.json)
- [.process/pr-packets/single/validation.json](.process/pr-packets/single/validation.json)
