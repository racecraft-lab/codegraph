...
- **SC-005**: The reproduction notes and UAT runbook allow a maintainer to rerun the prototype validation from a clean checkout using only documented local steps and package-shipped or locally generated assets, and the decision document states the SPEC-005-ready serving model for embedded static assets and local graph APIs.
