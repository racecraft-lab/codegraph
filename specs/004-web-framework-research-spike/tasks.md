...
- [ ] T002 Validate the UAT runbook against existing `spec.md` and `plan.md`, then update any stale SPEC-004 paths or commands in `specs/004-web-framework-research-spike/quickstart.md`
...
- [ ] T016 [P] [US1] Gather official documentation and live package/repository metadata for graph-rendering library candidates in `/tmp/spec-004-web-framework-research/graph-renderers.md`
...
- [ ] T018 [US1] Apply hard gates to every framework candidate and selected graph-renderer option, excluding any failed candidate from final ranking in `docs/design/web-framework-decision.md`
...
- [ ] T020 [US1] Select exactly one framework stack and one graph-rendering approach, then record runner-up tradeoffs and rejection rationale in `docs/design/web-framework-decision.md`
...
**Goal**: Prove the chosen stack can render representative CodeGraph data from this repository and a 1k-node target or documented fallback, with browser screenshot evidence.
...
- [ ] T022 [US2] Generate or simulate the 1k-node graph target into `/tmp/spec-004-web-framework-research/data/one-k-node-target.json` and record node/edge counts in `docs/design/web-framework-decision.md`
...
- [ ] T026 [US2] Capture the 1k-node target browser screenshot or required no-screenshot fallback evidence at `docs/design/assets/spec-004/one-k-node-target.png`
...
- [ ] T028 [US2] Record graph interaction observations, first visible render timing, machine/browser context, asset size notes, readability notes, and prototype limitations in `docs/design/web-framework-decision.md`
...
- [ ] T031 [US2] Record the final self-repo UAT result as pass, pass with limitation, or fail in `docs/design/web-framework-decision.md`
...
- [ ] T036 Validate the reproduction and UAT steps against the actual commands, artifact paths, screenshots, and prototype outcomes in `specs/004-web-framework-research-spike/quickstart.md`
- [ ] T037 Confirm the durable diff contains no production web source, no long-lived prototype source, no generated web build output, no CDN/runtime hosted-service dependency, and no non-permissive dependency adoption; record the result in `docs/design/web-framework-decision.md`
...
Task: "Gather official documentation and live package/repository metadata for graph-rendering library candidates in /tmp/spec-004-web-framework-research/graph-renderers.md"
```
...
Task: "Generate or simulate the 1k-node graph target into /tmp/spec-004-web-framework-research/data/one-k-node-target.json"
```
