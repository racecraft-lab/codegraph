...
# as workflow-template.md). All template tokens were substituted at scaffold.
#
...
#     the existing roadmap resolves as ../../docs/ai/specs/<roadmap-filename>.md.
up: "[CodeGraph Intelligence Platform roadmap](../../docs/ai/specs/intelligence-platform-technical-roadmap.md)"
related: []                  # list of relative []() links; carried, unenforced in v1
status: ""                   # carried, unenforced in v1
rank:                        # carried, unenforced in v1
spec_id: "SPEC-009"         # namespace-matches the containing directory
structureVersion: 1          # keep in sync with the lint scripts' hardcoded literal
---

# SPEC-009 — Map of Content
