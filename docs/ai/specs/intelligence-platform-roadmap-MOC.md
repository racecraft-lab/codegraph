...
- [SPEC-027 OKF Knowledge Ingestion and Code Linkage](SPEC-027-workflow.md)
...
**Why:** Team-scale value — producer-neutral project knowledge indexed and vectorized beside code, a dual-path LLM layer feeding generated wiki views and PR reviews, cross-repo contract impact, and OCaml coverage.
