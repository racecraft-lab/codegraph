...
**Why:** Team-scale value — a dual-path LLM layer feeding an auto-updating wiki and PR reviews, repository knowledge ingestion for Markdown/OKF bundles, cross-repo contract impact, and OCaml coverage.
